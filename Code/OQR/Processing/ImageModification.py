...
class Modify_Image:
    ...
    # Function to Resize Image (Pixel by Pixel)
    ...
    def convertToSVG(self, pngFile, svgFile):
        ...
        for y in range(h):
            for x in range(w):
                ...
                # Try to find the largest square from (x, y)
                square_size = 1
    ...
    def tiltSVG(self, svg_file, output_file, img_size=1250):
        ...
        for rect in root.findall(f".//{svg_ns}rect"):
            ...
            # new_x, new_y = self.apply_perspective_to_point(transform_matrix, (x, y))
